...
{/*/header*/}
{/* about breadcrumb */}
<BreadCrumb title = "About Company" page="About"/>
{/* //about breadcrumb */}
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
                <div className="box-wrap">
                    <div className="box-wrap-grid">
                        ...
                        <div className="info">
                            <p>Our</p>
                            <h4><Link to={"#url"}>Mission</Link></h4>
                        </div>
                    </div>
            ...
            <div className="row">
                ...
                <div className="col-lg-6 mt-lg-0 mt-5 pl-lg-4">
                    ...
                    <p className="mt-md-4 mt-3">Lorem ipsum viverra feugiat. Pellen tesque libero ut justo,
                        ...
                        <Link to={"#url"} className="btn btn-primary btn-style mt-md-5 mt-4">Get started now</Link>
                </div>
            </div>
        </div>
    </section>
